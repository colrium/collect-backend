...
export class ForgotPasswordDTO {
	@ApiProperty({
		...
		description: 'The Recovery account email or phone'
	})
	username: string;
...
export class ForgotPasswordResponse {
	@ApiProperty({
		example:
			'Account Recovery mail sent with instrunctions on how to proceed',
		description: 'Status of the initiated account recovery'
	})
	message: string;
}
